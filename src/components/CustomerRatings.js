        ...
        <section className="ratings">
            ...
            <div className="card-list">
                <article className="cust-card bg-lightgrey">
                    ...
                    <p>
                        I have had the best experience of my life at this restaurant. I will go back there
                        soon.
                    </p>
                </article>
                <article className="cust-card bg-lightgrey">
                    ...
                    <p>
                        I like the food at this restaurant and enjoy the ambience.
                    </p>
                </article>
                <article className="cust-card bg-lightgrey">
                    <div className="rating"><Rating num={5}/></div>
                    ...
                    <p>
                        Love the food and the online order services.
                    </p>
                </article>
                <article className="cust-card bg-lightgrey">
                    ...
                    <p>
                        Food is ok but it does not have much vegan options.
                    </p>
                </article>
            </div>
        </section>
